...
var stripe = Stripe('pk_test_51Ln4BEHggX0FnSfx4OdzXzloOQOZ14jwKFz5APNGNwj5tMOIAUvwGglNkhIIRfuf09GGWYUpLAr4kKNBl2SQ3xIA00A5PlDEIs');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " changed!"));
            }
...
if (updateForm) {
  document.querySelector('.form-user-data').addEventListener('submit', function (e) {
    ...
    console.log(form); // const newName = document.getElementById('name').value;
